...
class SongAdapterThird(private val list: List<SongListing>)
    : RecyclerView.Adapter<SongAdapterThird.SongViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SongViewHolder {
        val listItem = LayoutInflater.from(parent.context)
            .inflate(R.layout.song_list_item_purple, parent, false)
